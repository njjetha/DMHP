...
export class MapComponent implements OnInit {
  ...
  private margin: any = { top: 0, bottom: 0, left: 40, right: 60 };
  private svg: any;
  ...
  createMap() {
    ...
    tip.attr('class', 'd3-tip')
      ...
      .offset([-10, 0])
      .html(d => {
        const data = formattedDataTempCopy[d.properties.NAME_3];
...
if (formattedDataTempCopy[d.properties.NAME_3] != null) {
          const n = formattedDataTempCopy[d.properties.NAME_3].Total || 0;
